...
namespace GestaoPatrimonios.Repositories
{
    public class SolicitacaoTransferenciaRepository : ISolicitacaoTransferenciaRepository
    {
        ...
        public void Atualizar(SolicitacaoTransferencia solicitacaoTranferencia)
        {
            if (solicitacaoTranferencia == null)
            {
                return;
            }

            SolicitacaoTransferencia solicitacaoBanco = _context.SolicitacaoTransferencia.Find(solicitacaoTranferencia.TransferenciaID);
            ...
            solicitacaoBanco.DataResposta = solicitacaoTranferencia.DataResposta;
            solicitacaoBanco.StatusTransferenciaID = solicitacaoTranferencia.StatusTransferenciaID;
            solicitacaoBanco.UsuarioIDAprovacao = solicitacaoTranferencia.UsuarioIDAprovacao;
