...
namespace GestaoPatrimonios.Repositories
{
    public class StatusTransferenciaRepository : IStatusTransferenciaRepository
    {
        ...
        {
            return _context.StatusTransferencia.OrderBy(statusTransferencia => statusTransferencia.NomeStatus).ToList();
        }
        ...
        {
            return _context.StatusTransferencia.FirstOrDefault(statusTransferencia => statusTransferencia.NomeStatus.ToLower() == nomeStatus.ToLower());
        }
        ...
        {
            if (statusTransferencia == null) { return; }

            StatusTransferencia tipoBanco = _context.StatusTransferencia.Find(statusTransferencia.StatusTransferenciaID);

            tipoBanco.NomeStatus = statusTransferencia.NomeStatus;
